...
def acrescimo_nota_bb(nota_sozinho, nota_com_ajuda):
    ...
    acrescimo_nota_bb = (float(nota_com_ajuda) - float(nota_sozinho))*0.25
    if nota_com_ajuda > nota_sozinho:
      return round(acrescimo_nota_bb, 1)
    else: 
      return 0    
...
def maior_dia_do_mes(mes, ano):
    ...
    if mes == 1 and bissexto != 0:
     return 31
    elif mes == 2 and bissexto == 0:
        return 29
    elif mes == 3 and bissexto != 0: 
        return 31
    elif mes == 4 and bissexto != 0:
        return 30
    elif mes == 5 and bissexto != 0:
        return 31
    elif mes == 6 and bissexto != 0:
        return 30
    elif mes == 7 and bissexto != 0:
        return 31
    elif mes == 8 and bissexto != 0:
        return 31
    elif mes == 9 and bissexto != 0:
        return 30
    elif mes == 10 and bissexto != 0:
        return 31
    elif mes == 11 and bissexto != 0:
        return 30
    elif mes == 12 and bissexto != 0:
        return 31
    else:
        return 28
